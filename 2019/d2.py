...
first need to get the values at the input positions: position 9 contains 30, and
position 10 contains 40.  Add these numbers together to get 70.  Then, store
    ...
    for noun in range(100):
        for verb in range(100):
            ...
            try:
                ...
                #logging.error('Handled exception: %s', exc)
                continue

            if mach.mem[0] == target:
                logging.info('FOUND! %s %s', noun, verb)
                found = True
                break
